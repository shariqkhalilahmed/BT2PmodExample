...
#
# Generated by export_simulation on Thu Mar 02 15:19:39 -0500 2017
#
################################################################################
...
switch to the './bt_design.sh' script.

./bt_design.sh -reset_run
...
./bt_design.sh -noclean_files

For more information on the script, please type './bt_design.sh -help'.
